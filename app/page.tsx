    ...
    <div>
      <div className=" bg-black items-center">
        ...
        >
          {/* Navigation Bar */}
          <Navbar />
          <div className="px-4 py-2 rounded-3xl border border-gray-700 bg-gray-400/20 w-fit text-center text-gray-200  mx-auto mt-10 sm:w-90 sm:text-lg  ">
          ...
          <div className="flex flex-col-reverse items-center mt-10 space-y-3  sm:flex-row  sm:space-y-0 mx-auto ">
            ...
            <div className="bg-custom-cyan text-black w-30 rounded-sm text-center py-1.5 mt-5 sm:mb-5 ">
      ...
      <div>
        ...
        <div className="lg:flex lg:flex-row">
          <div className=" lg:w-[50%] ">
            <div>
              <h1 className=" w-89  sm:w-100 mx-auto mt-6 text-center  text-4xl sm:text-4xl md:w-120 lg:text-start lg:ml-9 ">
                <span className="pr-2">
                  To upscale your
                ...
                <span className="pl-2">to the next level</span>
              </h1>
            </div>

            <div className="w-[90%] mt-4 mx-auto text-sm sm:text-sm sm:mt-5">
              <p className="text-center mb-3 md:text-start">
          ...
          <div>
            ...
            <div className="mt-6 w-90 ml-3 sm:w-150 md:w-180 lg:w-130">
              <Image
      ...
      <div className="mt-10">
        ...
        <div className="mx-auto mt-5 w-full max-w-[1000px]">
      ...
      <div className="mt-10 md:mx-5 xl:mt-15 ">
          ...
          <div className="border-2 border-custom-cyan/60 py-5 px-5 rounded-2xl lg:w-1/2 lg:ml-20 md:mx-10 mx-4 sm:mx-10">
            ...
            <form className="mt-5 space-y-5">
              <input
                type="text"
                placeholder="Name"
                className="bg-gray-500 w-full rounded-xl py-2 px-4 xl:text-xl"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <textarea
                ...
                className="bg-gray-500 h-27 w-full rounded-xl py-2 px-4 xl:text-xl"
              ></textarea>

              <button
                type="submit"
                className=" xl:text-lg xl:font-semibold w-full text-center bg-custom-cyan rounded-xl py-2 text-lg text-black hover:bg-custom-cyan/80 transition"
              >
                Send Message
              </button>
            </form>
