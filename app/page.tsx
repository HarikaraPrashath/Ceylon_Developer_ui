      ...
      <div className="bg-white text-black dark:bg-black  dark:text-white min-h-screen border-4 border-white dark:border-hidden ">
        ...
        <div className="bg-white dark:bg-black items-center ">
          ...
          >
            ...
            <div className="text-center mt-6 w-[297px] h-[90px] mx-auto 
            sm:w-[500px] sm:h-[165px]
            md:w-[606px] md:h-[96px]
            xl:w-[851px] xl:h-[150px]
            2xl:w-[851px] 2xl:h-[185px]
            ">
              <h1 className="text-[40px] font-[600] leading-[45px]
            ...
            <h1 className="mt-10 text-[14px] font-[400] leading-[20px] mx-auto text-center w-[297px] h-[90px]
            ...
            lg:w-[711px] lg:h-[50px] lg:font-[400] lg:text-[18px] lg:leading-[25px] lg:mt-15
            xl:w-[711px] xl:h-[56px] xl:font-[400] xl:text-[20px] xl:leading-[28px] 
            2xl:w-[711px] 2xl:h-[60px] 2xl:font-[400] 2xl:text-[22px] 2xl:leading-[30px]  
            ">
              Pushing the boundaries of what&apos;s possible in the digital realm. Join us on this journey into the future of technology.
            </h1>

            {/* Buttons + Users */}
            <div className="flex flex-col-reverse items-center mt-10 space-y-3  mx-auto
            ...
            ">
              <div className="bg-custom-cyan text-black  rounded-sm text-center mt-5
              ...
              ">
                <button type="submit" className="font-semibold cursor-pointer text-[14px]  py-[9px] px-[18px] w-[122px] h-[38px] 
              ...
              <div className="flex  items-center flex-row gap-3 sm:mt-1
              ...
              ">
                <Image
                  ...
                  "
                />
                <p className="text-[14px] font-[400] leading-[20px] w-[149px] h-[40px]
            ...
            <div className="lg:flex lg:flex-row max-w-[1280px] mx-auto 2xl:mx-30 -mt-20 lg:mx-15 xl:ml-40">
              ...
              <div className="lg:w-[425px] lg:h-[468px] mx-auto ">
                <div className="text-center  ">
                  <h1 className="leading-[35px] text-[36px] font-medium  w-[335px] h-[105px] 
          ...
          {/* line */}
          <Image src="/Images/cureveLine.png" alt="cureveLine" width={1000} height={1000} className="w-[2000px] mx-auto mb-10 lg:mt-10 " priority />
          ...
          <div className="mt-10 md:mx-5 xl:mt-15 lg:block w-[345px] h-[815px]  mx-auto sm:hidden lg:flex xl:ml-30">
            <div className="flex flex-col lg:flex-row gap-10 xl:gap-0 xl:mx-10  lg:ml-6  ">
              ...
              <div className="lg:w-[40%]  xl:ml-10  xl:w-[562px] xl:h-[455px] ">
                ...
                ">
                  Get in <span className="[font-family:var(--font-kaushan)] pr-2">Touch</span>
                </h1>
                <p className="mx-auto text-center text-[14px] leading-[25px] font-[400] w-[280px] h-[60px] xl:text-xl xl:text-start mt-5 
                ...
                <h1 className="mt-7 text-[20px] w-[156px] h-[25px] leading-[25px] font-[400]
                ...
                <div className="space-y-5 mt-7 ">
                  <div className="flex flex-row  items-center bg-gray-200 dark:bg-gray-700 w-[201px] h-[34px] rounded-[32px] py-[5px] px-[10px] 
                  ...
                  ">
                    <div className="rounded-full w-[24px] h-[24px] bg-custom-cyan flex items-center justify-center lg:w-[32px] lg:h-[33px]
                    xl:w-[32px] xl:h-[32px] xl:rounded-[100px] xl:gap-[10px]
                    ">
                      <ArrowRight color="black" className="w-[10.79px] h-[10.34px] top-[6.58px] left-[6.75px]
                      lg:w-[14.22px] lg:h-[14.22px] lg:top-[9.05] lg:left-[8.89px]
                      xl:w-[14.22px] xl:h-[14.22px] xl:top-[9.05px] xl:left-[8.89px]
                      " />
                    </div>
                    <p className="pl-3 text-[14px] font-[400] leading-[20px]
                  ...
                  ">
                    <div className="rounded-full w-[24px] h-[24px] bg-custom-cyan flex items-center justify-center
                    lg:w-[32px] lg:h-[33px]
                      xl:w-[32px] xl:h-[32px] xl:rounded-[100px] xl:gap-[10px]
                    ">
                      <ArrowRight color="black" className="w-[10.79px] h-[10.34px] top-[6.58px] left-[6.75px]
              ...
              ">
                <h1 className="text-[20px] font-[400] leading-[25px]
                ...
                <p className="text-[14px] leading-[20px] text-gray-700 dark:text-gray-300
                ...
                <form className="mt-5 space-y-5">
                  <input type="text" placeholder="Name" className="bg-gray-200 dark:bg-gray-900 w-[315px] h-[40px] rounded-[12px] py-[10px] px-[20px]
                  lg:w-[465px] lg:h-[57px] lg:rounded-[12px] lg:py-[16px] lg:px-[20px]
                  xl:w-[584px] xl:h-[62px] xl:rounded-[12px] xl:py-[16px] xl:px-[16px]
                  " />
                  <input type="email" placeholder="Email" className="bg-gray-200 dark:bg-gray-900 w-[315px] h-[40px] rounded-[12px] py-[10px] px-[20px]
                  lg:w-[465px] lg:h-[57px] lg:rounded-[12px] lg:py-[16px] lg:px-[20px]
                    xl:w-[584px] xl:h-[62px] xl:rounded-[12px] xl:py-[16px] xl:px-[16px]
                  " />
                  <input type="text" placeholder="Subject" className="bg-gray-200 dark:bg-gray-900 w-[315px] h-[40px] rounded-[12px] py-[10px] px-[20px]
                  lg:w-[465px] lg:h-[57px] lg:rounded-[12px] lg:py-[16px] lg:px-[20px]
                    xl:w-[584px] xl:h-[62px] xl:rounded-[12px] xl:py-[16px] xl:px-[16px]
                  " />
                  <textarea placeholder="Your message" className="bg-gray-200 dark:bg-gray-900 w-[315px] h-[40px] rounded-[12px] py-[10px] px-[20px]
          ...
          lg transition-colors duration-300">
            <h1 className="text-center text-[36px] leading-[35px] font-[500] text-gray-800 dark:text-white
            ...
            lg:w-[639px] lg:h-[110px] lg:font-[500] lg:text-[48px] lg:leading-[55px] lg:-ml-10
            ...
            <p className="text-center mt-5 w-[317px] h-[60px] ext-[14px] fount-[400] leading-[25px]  text-gray-700 dark:text-gray-300  mx-auto 
            ...
            lg:w-[639px] lg:h-[50px] lg:text-[18px] lg:font-[400] lg:leading-[25px] lg:-ml-10 
            ...
            <div className="mt-10 mx-auto bg-custom-cyan text-black dark:text-gray-900 text-center hover:opacity-90 transition w-[114px] h-[38px] rounded-[4.76px] py-[9px] px-[18px]
            ...
            ">
              <button type="button" className="text-[14px] leading-[20px] font-[400] w-[78px] h-[20px]
