      ...
      <div className="bg-white dark:bg-black items-center ">
        ...
        >
          ...
          <div className="flex flex-col-reverse items-center mt-10 space-y-3  mx-auto
            ...
            ">
            <div className="bg-custom-cyan text-black  rounded-sm text-center mt-5 cursor-pointer
        ...
        <div className="min-h-screen bg-white dark:bg-black flex justify-center">
          ...
          ">
              ...
              ">
                ...
                ">
                  ...
                  " />
                    ...
                    "
                    >
                      <p className="xl-text-[22px]  w-[98px] h-[20px] leading-[20px]
            ...
            <div className="bg-gradient-to-b from-gray-100 to-gray-300   dark:from-[rgba(24,24,24,0.35)]
