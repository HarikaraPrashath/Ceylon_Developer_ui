            ...
            <div className="border w-full max-w-[1440px] h-auto px-4 py-3 rounded-xl mt-7 lg:flex lg:flex-row xl:px-10 mx-auto">
              <div>
                ...
                <div className="">
                  ...
                  <p className="ml-1 text-sm xl:text-lg">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Perspiciatis possimus temporibus sapiente non, numquam modi
                    aut quo consectetur saepe qui voluptatem reprehenderit sed,
                    obcaecati blanditiis, pariatur eveniet rem{" "}
                  ...
                  <div className="bg-custom-cyan w-35 rounded-sm text-black flex mt-4 py-1 sm:ml-1 lg:mt-10 xl:w-max xl:px-2 xl:py-2">
                    <button type="submit" className="ml-3 xl:text-xl">
                      View Details{" "}
                    </button>
                    <ArrowUpRight className="w-8 pl-2" />
                  </div>
              ...
              <div>
                <Image
                  ...
                  width={1000}
                  height={1000}
                  className="w-[2000px] mx-auto mb-10 lg:w-[1500px] lg:mt-5"
                  priority
                />
              </div>
            </div>
             ...
             <div className="border w-full max-w-[1440px] h-auto px-4 py-3 rounded-xl mt-7 lg:flex lg:flex-row xl:px-10 mx-auto">
              <div>
                <div className="flex flex-row  justify-start gap-7 sm:ml-2 sm:mt-5 lg:flex-col xl:flex-row">
                  ...
                  <div className=" text-xs border border-green-900 py-1 px-2 rounded-3xl lg:w-max lg:px-3 lg:py-2 lg:-mt-4  xl:w-mac xl:mt-0">
                    <h1 className="">Figma Design</h1>
                  </div>
                </div>
                <div className="">
