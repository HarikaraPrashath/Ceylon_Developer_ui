      ...
      <div className="xl:hidden ">
        ...
        <div className="">
          <div className=" md:flex md:flex-row md:justify-center md:gap-2 ">
            <div className="bg-gray-100 dark:bg-gray-900 w-80 h-90 mx-auto mt-8 rounded-3xl sm:w-100 sm:h-104 md:w-90 md:h-95 md:px-3 ">
              <Image
              ...
              />
              <div className="flex flex-row bg-gray-200 dark:bg-gray-800 w-74 mx-auto mt-4 rounded-2xl p-4 justify-between sm:w-90 md:w-80">
                <div>
          ...
          <div className=" md:flex md:flex-row md:justify-center md:gap-2 sm:hidden ">
            <div className="bg-gray-100 dark:bg-gray-900 w-80 h-90 mx-auto mt-8 rounded-3xl sm:w-100 sm:h-104  md:h-95 md:px-3 md:w-90">
              <Image
                src="/Images/Team Image.png"
                alt="Team Image"
                width={200}
        ...
        <div className="bg-custom-cyan w-35 flex flex-row mx-auto py-2 rounded-xl text-black dark:text-black gap-2  justify-center mt-8 mb-10">
