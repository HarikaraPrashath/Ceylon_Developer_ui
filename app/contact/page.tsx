    ...
    <div className="bg-white text-black dark:bg-black dark:text-white min-h-screen border-4 border-white dark:border-hidden">
      ...
      <div className="">
        ...
        <div className="mt-10  max-w-[1440px]">
          ...
          xl:w-[754px] xl:h-[60px] xl:text-[64px] xl:leading-[60px] xl:ml-100 xl:mt-30
          2xl:w-[754px] 2xl:h-[70px] 2xl:text-[72px] 2xl:leading-[70px] 2xl:ml-100 2xl:mt-30
          ">
            We&apos;re Here to{" "}
          ...
          xl:w-[524.96px] xl:h-[56px] xl:text-[20px] xl:leading-[28px] xl:ml-130
          2xl:w-[524.96px] 2xl:h-[60px] 2xl:text-[22px] 2xl:leading-[30px] 2xl:ml-130
          ">
          ...
          xl:w-[992px] xl:h-[676px] xl:rounded-[22px] xl:border-[1px] xl:py-[45px] xl:px-[110px] xl:ml-70
          2xl:w-[1041px] 2xl:h-[704px] 2xl:rounded-[22px] 2xl:border-[1px] 2xl:py-[50px] 2xl:px-[110px] 2xl:ml-70
          ">
          ...
          <div className="sm:flex sm:flex-row sm:justify-between">
            {[
              ...
              <div key={idx} className="text-center mt-10  xl:ml-30 2xl:w-[1080px] ">
          ...
          xl:w-[913px] xl:h-[385px]  xl:ml-80 xl:mt-30
          2xl:w-[984px] 2xl:h-[389px] 2xl:top-[1904px] 2xl:left-[240px] 2xl:rounded-[20px] 2xl:px-[70px] 2xl:py-[42px]
                    ">
            <h1 className="text-center w-[317px]  h-[71px] font-[500] text-[36px] leading-[35px] -ml-5
            sm:w-[359px] sm:h-[81px] sm:text-[30px] sm:leading-[40px] sm:ml-7
            md:w-[433px] md:h-[101px] md:text-[40px] md:leading-[50px] md:ml-7
            lg:w-[639px] lg:h-[111px] lg:text-[48px] lg:leading-[55px] lg:ml-7
            xl:w-[777px] xl:h-[121px] xl:text-[64px] xl:leading-[60px] 
            2xl:w-[844px] 2xl:h-[121px] 2xl:text-[64px] 2xl:leading-[60px] 2xl:mx-auto
            ">
              Let&apos;s Turn Your{" "}
            ...
            w-[317px] h-[60px] font-[600px] text-[14px] leading-[20px] mt-5 -ml-5
